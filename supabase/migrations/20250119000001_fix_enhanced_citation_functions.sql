-- Fix enhanced citation functions to include content_structure_category

-- Update get_enhanced_citations_by_domain to include content_structure_category
...
-- Update get_enhanced_citation_urls_by_domain to include content_structure_category
