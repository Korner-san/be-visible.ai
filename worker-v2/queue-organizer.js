...
async function runQueueOrganizer() {
  ...
  for (const accountState of dispatchableAccounts) {
    ...
    // total_prompts is queried dynamically — handles V1 (30 prompts) and V2 (50 prompts)
...
// Creates daily report with actual prompt count (dynamic — V1=30, V2=50, or any future value)
async function getOrCreateDailyReport(brandId, today) {
  ...
  // Query actual count so this works for both V1 (30 prompts) and V2 (50 prompts)
